...
int main()
{
    ...
    astar(graph, "Viman", "Kothrud", coordinates);
    cout<<'\n';
    cout<<"Dijkstras on small graph"<<endl;
    dijkstra(graph, "Viman", "Kothrud");
    cout<<'\n';

    // for large graph
// for large graph
ifstream inputFile2("graph_with_weights.txt");
...
double distance2;
while (inputFile2 >> source2 >> destination2 >> distance2)
{
    ...
    large_astar(large_graph, "0", "1000", coordinates);
    cout<<'\n';
    cout<<"Dijkstras on large graph"<<endl;
    large_dijkstra(large_graph, "0", "1000");
    cout<<'\n';
