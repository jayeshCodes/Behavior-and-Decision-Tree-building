...
# def generate_unique_coordinates(used_coordinates):
#     while True:
#         coord_x = random.randint(0, 200)
#         coord_y = random.randint(0, 200)
#         if (coord_x, coord_y) not in used_coordinates:
#             used_coordinates.add((coord_x, coord_y))
...
#             node2 = fields[1]
#             distance = fields[2]
#             # Generate unique random coordinates for each node
#             coord1_x, coord1_y = generate_unique_coordinates(used_coordinates)
#             coord2_x, coord2_y = generate_unique_coordinates(used_coordinates)
