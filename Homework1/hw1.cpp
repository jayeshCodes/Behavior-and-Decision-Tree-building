...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        // movement logic with spawn and cycleComplete
        // if (frame % 10 == 0)
        // {

        //     moveX(sprites[cycleCount]);
        //     if (sprites[cycleCount].xcomplete && cycleCount<2)
        //     {
        //         sprites[cycleCount + 1].spawn = true;
        //         cycleCount++;
        //     }
        // }
        if (frame % 10 == 0)
        {
            ...
            if (sprites[spriteIndex - 1].xcomplete && spriteIndex<3){
