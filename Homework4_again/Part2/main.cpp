...
// init window
sf::RenderWindow window(sf::VideoMode(GridSizeX *RoomSize, GridSizeY *RoomSize), "Behavior Trees");
...
public:
    ...
    void performAction()
    {
        ...
        case EVADE:
            ...
            estimatedFutureMonsterPosition = monster.position + monster.velocity * 5.0f; // Predict 5 seconds into the future
...
public:
    monsterAI()
    {
        monsterRoot = mbt.constructBehaviorTree();
    }
    void getAction()
    {
        monsterRoot->Evaluate();
    }
    ...
    void performAction()
    {
        ...
        case WANDER:
            ...
            {
                // Generate random coordinates within the grid bounds
                std::cout << "monster wander" << std::endl;
        ...
        case PURSUE:
            ...
            estimatedFuturePosition = character.position + character.velocity * 5.0f; // Predict 5 seconds into the future
